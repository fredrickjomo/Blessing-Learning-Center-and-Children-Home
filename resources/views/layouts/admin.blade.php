...
<div class="wrapper">
    ...
    <header class="main-header-top hidden-print">
        <a href="index.html" class="logo"><img class="img-fluid able-logo" src="assets/images/logo1.png" alt="Blessing L Center"></a>
    ...
    <aside class="main-sidebar hidden-print " >
        <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-chart"></i><span> Children </span><span class="label label-success menu-caption">New</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-book-open"></i><span> Sponsorships</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> View Requests</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Accept Requests</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Cancel Requests</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Terminate Sponsorships</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="fa fa-laptop"></i><span> Projects</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> View Projects</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Add New Project</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Edit/Update Project Information</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> Remove/Delete</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="fa fa-clone"></i><span> Events</span><i class="icon-arrow-down"></i></a>
                    <ul class="treeview-menu">
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i> View Events</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i>  Add Event</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i>  Edit/Update Event</a></li>
                        <li><a class="waves-effect waves-dark" href="#"><i class="icon-arrow-right"></i>  Remove/Delete</a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row m-b-30 dashboard-header">
                ...
                <div class="col-lg-2 col-sm-6">
                    <div class="col-sm-12 card dashboard-product">
                        <span>Confirmed Sponsorships</span>
